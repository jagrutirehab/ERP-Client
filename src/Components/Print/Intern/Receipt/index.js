...
const Receipt = ({ bill, center, intern }) => {
  ...
  const advance = parseFloat(receipt?.totalAmount);
          ...
          <View>
            <View style={{ ...styles.row, marginTop: "20px" }}>
              <Text style={{ ...styles.slot, border: "none", width: "65%" }}>
                No.&#160;
                {`${bill?.id?.prefix}${bill?.id?.internId}-${bill?.id?.value}`}
              </Text>
            ...
            <View style={{ ...styles.patientSection, marginBottom: 30 }}>
              ...
              <Text>
                ...
                >
                  {`${intern?.name} - ${intern?.id?.prefix}${intern?.id?.value}` ||
                    ""}
                </Text>
              </Text>
            </View>
            ...
            >
              <View style={styles.slot}>
                ...
                >
                  INR&#160;{toWords(parseInt(receipt.totalAmount || 0))}
                  &#160;ONLY
                </Text>
              </View>
              <Text style={styles.amount}></Text>
