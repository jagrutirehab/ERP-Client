...
const Deposit = ({ bill, center, patient }) => {
  const renderImage = () => {
    return (
  ...
  const advance = parseFloat(deposit?.totalAmount);
          ...
          <View>
            ...
            >
              <View style={styles.slot}>
                ...
                >
                  INR&#160;{toWords(parseInt(deposit.totalAmount || 0))}
                  &#160;ONLY
                </Text>
              </View>
              <Text style={styles.amount}></Text>
