    ...
    <React.Fragment>
      ...
      >
        ...
        >
          ...
          <Text style={styles.col4}>SpO2 (%)</Text>
          <Text style={styles.col4}>BSL (mg/dL)</Text>
        </View>
        <View
          style={{
            ...styles.borderBottom,
        ...
        >
          <View style={styles.row}>
            ...
            <Text style={styles.col4}>{chart.spo2 || ""}</Text>
            <Text style={styles.col4}>{chart.bloodSugar || ""}</Text>
          </View>
        </View>
      </View>
    </React.Fragment>
