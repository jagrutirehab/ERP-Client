    ...
    <React.Fragment>
      <div>
        <Row className="align-items-center">
          ...
          <Col xs={12} md={6}>
            <Row>
              <Col xs={12} md={12} lg={6} className="mb- align-items-center">
              ...
              <Col xs={12} md={12} lg={6} className="mb-">
              ...
              {/* <Col className="mb- text-center" xs={12} md={12} lg={4}></Col> */}
            </Row>
          </Col>
        </Row>
      </div>
