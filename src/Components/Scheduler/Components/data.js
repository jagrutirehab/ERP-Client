...
/**
 *
 * @param date - Pass the date for filtering the events
 * @param events - Pass the events for filtering
 * @returns an array of events after proccessing
 */
const getAppointmentsByDates = (date, events) => {
  ...
  const sortByStartDate = eventList.sort(
