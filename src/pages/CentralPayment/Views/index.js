...
import AccountingApprovalDashboard from "./AccountingApprovalDashboard";
...
const Views = () => {
  ...
  const hasReportsPermission = hasPermission(
    "CENTRALPAYMENT",
    "CENTRALPAYMENTREPORTS",
    "READ",
  );
  const hasApprovalsPermission = hasPermission(
    "CENTRALPAYMENT",
    "CENTRALPAYMENTAPPROVAL",
    "READ",
  );
  const hasSpendingPermission = hasPermission(
    "CENTRALPAYMENT",
    "CENTRALPAYMENTSPENDING",
    "READ",
  );
  const hasPaymentProcessingPermission = hasPermission(
    "CENTRALPAYMENT",
    "CENTRALPAYMENTPROCESSING",
    "READ",
  );
  const hasFinanceApprovalPermission = hasPermission(
    "CENTRALPAYMENT",
    "CENTRALPAYMENTFINANCEAPPROVAL",
    "READ",
  );

  const hasAccountingApprovalPermission = hasPermission(
    "CENTRALPAYMENT",
  ...
  const availableViews = [
    ...
    {
      name: "Accounting Approval Dashboard",
      view: ACCOUNTING_APPROVAL_VIEW,
      hasAccess: hasAccountingApprovalPermission,
      order: 2,
    },
    {
