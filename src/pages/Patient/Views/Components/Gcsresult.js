const GCSResultComponent = ({ resultData }) => {
  const {
    systemTotalScore,
  ...
  const getSeverityColor = (severity) => {
    if (severity === "Mild") return "text-warning";
    if (severity === "Moderate") return "text-orange";
    ...
    <div className="">
      <div className="p-4 bg-light border border-primary rounded shadow-lg">
        <h2 className="h5 h4-sm fw-semibold text-primary mb-3">
          ...
          Glasgow Coma Scale (GCS) Results
        </h2>
        ...
        <div className="mb-4 p-4 border border-primary-subtle rounded-3 bg-light shadow-sm">
          <div className="row g-3">
            <div className="col-12 col-sm-6 col-lg-3">
              <div className="bg-white border border-info-subtle rounded-3 p-3 shadow-sm h-100 text-center">
            ...
            <div className="col-12 col-sm-6 col-lg-3">
              <div className="bg-white border border-info-subtle rounded-3 p-3 shadow-sm h-100 text-center">
                ...
                <p
                  className={`mb-0 fw-bold fs-5 ${getSeverityColor(
                    systemSeverity
                  )}`}
                >
                  {systemSeverity ?? "N/A"}
...
export default GCSResultComponent;