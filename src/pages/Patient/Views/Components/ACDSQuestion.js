...
import ACDSAssesment from "./ACDSAssesment";
import ResultView from "./ACDSResult";
      ...
      <div className="bg-white shadow-xl rounded-2xl w-100">
        <div className="text-center mb-4">
          <h1 className="text-primary fw-bold display-6 display-md-5">
            ...
            ADHD Clinical Diagnostic Scale (ACDS) Assessment
          </h1>
        </div>

        {view === "psychologist" && (
          <ACDSAssesment onAssessmentComplete={handleAssessmentComplete} />
        )}
