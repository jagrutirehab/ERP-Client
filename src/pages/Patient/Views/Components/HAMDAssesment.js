...
const HAMDAssesment = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await dispatch(createHAMDTest(formData)).unwrap();
      openModal(
      ...
      <div className="mb-5 p-4 bg-light border border-primary rounded shadow-sm">
        ...
        <ul className="ps-3 text-secondary small fs-6">
          <li className="mb-2 text-black">
            <strong>Purpose:</strong> This test assists in assessing the severity of depressive symptoms in adults, adolescents, and children.
          </li>
