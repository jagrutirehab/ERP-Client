...
const PANSSAssessment = () => {
    ...
    const closeModal = () => {
        const unAnswered = panssQuestions.filter((q) => !answers[q.id]);
    ...
    const handleSubmit = (e) => {
        ...
        formData.append("Composite", scores.Composite);
            ...
            <div className="mb-5 p-4 bg-light border border-primary rounded shadow-sm">
                ...
                <ul className="ps-3 text-secondary small fs-6">
                    <li className="mb-2 text-black">
                        <strong>Purpose:</strong> This test helps in assessing the severity of schizophrenia symptoms, including positive, negative, and general psychopathology, based on patient responses.
                    </li>
                    <li className="mb-2 text-black">
...
export default PANSSAssessment;
