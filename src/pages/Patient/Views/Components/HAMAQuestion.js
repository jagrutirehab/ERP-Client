...
import HAMAAssesment from "./HAMAAssesment";
import ResultView from "./HAMAResult";
      ...
      <div className="bg-white shadow-xl rounded-2xl p-4 p-sm-5 w-100">
        <div className="text-center mb-4">
          <h1 className="text-primary fw-bold display-5">
            ...
            Hamilton Anxiety Rating Scale (HAM-A) Assessment
          </h1>
        </div>

        {view === "psychologist" && (
          <HAMAAssesment onAssessmentComplete={handleAssessmentComplete} />
        )}
