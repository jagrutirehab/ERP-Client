const RamsayResultComponent = ({ resultData }) => {
  const {
    systemTotalScore,
  ...
  const getSeverityColor = (severity) => {
    if (severity === "Optimal") return "text-success";
    if (severity === "Adequate") return "text-warning";
    if (severity === "Under-sedated") return "text-danger";
    if (severity === "Over-sedated") return "text-danger";
    if (severity === "Deeply Over-sedated") return "text-danger";
    return "text-primary";
  };
...
export default RamsayResultComponent;