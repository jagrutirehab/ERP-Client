...
import { calculateScores, getInterpretationAndRecommendations, acdsQuestions } from "./QuestionData/ACDSQuestions";
          ...
          <div className="mb-5 p-4 bg-light border border-primary rounded shadow-sm">
            ...
            <ul className="ps-3 text-secondary small fs-6">
              <li className="mb-2 text-black">
                <strong>Purpose:</strong> This test assists in screening and diagnosing symptoms of Attention-Deficit/Hyperactivity Disorder (ADHD) in adults, by assessing patterns of inattention, hyperactivity, and impulsivity based on patient responses.
              </li>
              <li className="mb-2 text-black">
