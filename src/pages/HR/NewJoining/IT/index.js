...
const NEWJoiningIT = () => {
    ...
    const hasUserPermission = hasPermission("HR", "NEW_JOINING_IT", "READ");
        ...
        >
            <div className="content-wrapper">
                <div className="text-center text-md-left">
                    <h1 className="display-6 fw-bold text-primary">NEW JOINING IT APPROVALS</h1>
                </div>
