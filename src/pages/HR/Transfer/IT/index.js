...
const TransferEmployeeIT = () => {
    ...
    const hasUserPermission = hasPermission("HR", "TRANSFER_EMPLOYEE_IT", "READ");
        ...
        >
            <div className="content-wrapper">
                <div className="text-center text-md-left">
                    <h1 className="display-6 fw-bold text-primary">TRANSFER EMPLOYEE IT APPROVALS</h1>
                </div>
...
export default TransferEmployeeIT;
