...
const OutgoingEmployeeApprovals = () => {
    ...
    >
      <div className="content-wrapper">
        <div className="text-center text-md-left">
          <h1 className="display-6 fw-bold text-primary">OUTGOING EMPLOYEE TRANSFER APPROVAL</h1>
        </div>
...
export default OutgoingEmployeeApprovals;
