...
import { techIssues } from '../../dummyData';
...
const TechIssue = ({ activeTab }) => {
    ...
    const baseColumns = [
        ...
        {
            name: <div>Issue Description</div>,
            selector: row => <ExpandableText text={row.issueDescription} />,
            wrap: true,
            grow: 2,
            minWidth: "300px"
        },
    ...
    const historyColumns = [
        ...
        {
            name: <div>Confirmed By</div>,
            selector: row => row.confirmedBy || "-",
            wrap: true,
            minWidth: "150px"
        },
        {
            name: <div>Approved / Rejected By</div>,
    ...
    return (
        <div className='px-3'>
            ...
            />
            <ApproveModal isOpen={approveOpen} toggle={() => setApproveOpen(!approveOpen)} type="TECH_ISSUES"/>
