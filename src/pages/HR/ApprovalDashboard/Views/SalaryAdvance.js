...
import { salaryAdvances } from '../../dummyData';
...
const SalaryAdvance = ({ activeTab }) => {
    ...
    return (
        <div className='px-3'>
            ...
            />
            <ApproveModal isOpen={approveOpen} toggle={() => setApproveOpen(!approveOpen)} type={"SALARY_ADVANCE"} />
