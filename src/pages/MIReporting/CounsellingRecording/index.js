    ...
    import {  fetchCounsellingRecordings } from "../../../store/features/miReporting/miReportingSlice";
...
const CounsellingRecording = () => {
    ...
    const data = useMemo(() => counsellingRecordings?.data || [], [counsellingRecordings]);
            ...
            <div className="p-3">
                ...
                <div className="col-sm-6 col-4">
                    ...
                    <Button
                        ...
                        counsellingRecordings.length === 0
                        }
                        className="w-auto"
                    >
    ...
    export default CounsellingRecording;
