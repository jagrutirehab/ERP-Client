...
import { createTrainings, getRolesDisctinct } from '../../../helpers/backend_helper'
...
const Upload = () => {
    const [forms, setForms] = useState([{ id: 0, trainingName: '', roles: [], repeatFrequency: '', questionary: [] }])
    ...
    const addForm = () => {
        ...
        setForms([...forms, { id: newId, trainingName: '', roles: [], repeatFrequency: '', questionary: [] }])
    }
    ...
    const handleSubmit = async (e) => {
        ...
        forms.forEach((form, index) => {
            ...
            if (form.questionary.length > 0) {
                formData.append(`trainings[${index}][questionary]`, JSON.stringify(serializeQuestionary(form.questionary)))
            }
        ...
        try {
            ...
            setForms([{ id: 0, trainingName: '', roles: [], repeatFrequency: '', questionary: [] }])
            setFiles({})
