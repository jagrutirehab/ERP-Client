...
import { changeStatus, getRaisedIssues } from "../../../helpers/backend_helper";
import ApprovalModal from "../Components/ApprovalModal";
import Select from "react-select";
import { useSelector } from "react-redux";
import { MyRaisedTicketsColumns } from "../Columns/MyRaisedTickets";

const issueTypes = ["TECH", "HR", "FINANCE", "MAINTENANCE", "COMPLAINT","OPERATIONAL"];
...
const MyRaisedTickets = () => {
    ...
    const hasUserPermission = hasPermission("ISSUES", "MY_RAISED_TICKETS", "READ");
    const hasWritePermission = hasPermission("ISSUES", "MY_RAISED_TICKETS", "WRITE");
    const hasDeletePermission = hasPermission("ISSUES", "MY_RAISED_TICKETS", "DELETE");
        ...
        <>
            ...
            >
                <div className="text-center text-md-left mb-4">
                    <h1 className="display-6 fw-bold text-primary">MY RAISED TICKETS</h1>
                </div>
                ...
                {/* Issues Table */}
                <DataTableComponent
                    columns={MyRaisedTicketsColumns(
