...
import { changeStatus, getFinanceIssues } from "../../../helpers/backend_helper";
import ApprovalModal from "../Components/ApprovalModal";
import Select from "react-select";
import { useSelector } from "react-redux";
import { FinanceIssuesCol } from "../Columns/FinanceIssuesCol";
...
const FinanceIssues = () => {
  ...
  const hasUserPermission = hasPermission("ISSUES", "FINANCE_ISSUES", "READ");
  const hasWritePermission = hasPermission("ISSUES", "FINANCE_ISSUES", "WRITE");
  const hasDeletePermission = hasPermission("ISSUES", "FINANCE_ISSUES", "DELETE");
  ...
  const loadIssues = async () => {
    try {
      ...
      const response = await getFinanceIssues(params);
