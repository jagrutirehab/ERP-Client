      ...
      <form onSubmit={validation.handleSubmit}>
        <Row className="mb-4">
          <Col md={3}>
            ...
            {!editingItem && codeStatus === "taken" && (
              <div className="im-code-hint" style={{ color: "#e04f4f" }}>
        ...
        <Nav tabs className="im-form-tabs">
          <NavItem>
            ...
            >
              <i className="bx bx-layer"></i> General Data
            </NavLink>
          </NavItem>
          <NavItem>
            <NavLink
            ...
            >
              <i className="bx bx-box"></i> Inventory &amp; Planning
            </NavLink>
          </NavItem>
          <NavItem>
            <NavLink
              className={classnames({ active: activeTab === "traceability" })}
              onClick={() => setActiveTab("traceability")}
            >
              <i className="bx bx-pulse"></i> Traceability &amp; Control
            </NavLink>
          </NavItem>
          <NavItem>
            <NavLink
            ...
            >
              <i className="bx bx-cog"></i> Attributes &amp; Media
            </NavLink>
          </NavItem>
        </Nav>
        ...
        <TabContent activeTab={activeTab}>
          ...
          <TabPane tabId="general">
              ...
              {CATEGORY_LEVELS.map((lvl, idx) => {
                ...
                return (
                  <Col md={3} key={lvl.key}>
                    <Label>
                      {lvl.label}{" "}
                      {lvl.required && <span className="text-danger">*</span>}
                    </Label>
                    <Input
                      type="select"
                      value={v[lvl.key]}
            ...
            <div className="im-two-col-panel">
              <div>
                <FormSectionLabel icon="bx-note" text="Description & Unit" />
                <div className="mb-4">
              ...
              <div>
                ...
                <Row>
                  ...
                  <Col md={6} className="mb-4">
                    ...
                    <FormFeedback>{validation.errors.basePrice}</FormFeedback>
                  </Col>
                </Row>
          ...
          <TabPane tabId="inventory">
            ...
            <Row>
              <Col md={4} className="mb-4">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setNested("planning.reorderQty", parseNum(e.target.value))
                  }
                />
              </Col>
              <Col md={4} className="mb-4">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setNested("planning.leadTimeDays", parseNum(e.target.value))
                  }
                />
              </Col>
              <Col md={4} className="mb-4">
            ...
            <div className="im-checkbox-row mb-4" style={{ maxWidth: 340 }}>
              <input
                type="checkbox"
              ...
              />
              <span className="small">Allow invoice without stock</span>
            </div>
          ...
          <TabPane tabId="traceability">
            ...
            <Row>
              <Col md={6} className="mb-4">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setNested("procurementInfo.defaultVendorId", e.target.value)
                  }
                />
              </Col>
              <Col md={6} className="mb-4">
              ...
              <Col md={6} className="mb-4">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setNested("procurementInfo.countryOfOrigin", e.target.value)
                  }
                />
              </Col>
            </Row>
            ...
            <div className="im-checkbox-grid mb-4">
              {[
                ...
                <div className="im-checkbox-row" key={key}>
                  <input
                    type="checkbox"
            ...
            <FormSectionLabel icon="bx-purchase-tag" text="Tax & GL Accounts" />
            <Row>
              <Col md={4} className="mb-4">
          ...
          <TabPane tabId="attributes">
            <FormSectionLabel icon="bx-customize" text="Custom Attributes" />
                ...
                >
                  <Col md={5}>
                    <Input
                      ...
                      value={a.key}
                      onChange={(e) =>
                        updateCustomAttribute(idx, "key", e.target.value)
                      }
                    />
                  </Col>
                  <Col md={6}>
            ...
            {v.productImages.length === 0 ? (
              <div className="text-muted small">No images uploaded yet.</div>
            ) : (
